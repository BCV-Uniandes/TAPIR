...
_C.MODEL.SINGLE_PATHWAY_ARCH = ["2d", "c2d", "i3d", "slow", "x3d", "mvit", "videoswintransformer"]
...
# filename.
_C.AVA.TRAIN_GT_BOX_LISTS = ["train.csv"]
_C.AVA.TRAIN_PREDICT_BOX_LISTS = []

# Filenames of box list files for test.
_C.AVA.TEST_PREDICT_BOX_LISTS = ["val_preds.csv"]
...
# Annotation dir of groundtruth in coco 
_C.AVA.COCO_ANN_DIR = " "

# Dataset cataracts
_C.AVA.CATARACTS = False
# -----------------------------------------------------------------------------
...
_C.TASKS.TASKS = ["actions", "phases", "steps", "tools"]

# Number of classes per extra head
_C.TASKS.NUM_CLASSES = [16, 11, 21, 7]
...
_C.FASTER.DETR = False

# Path to .pth file with the detected train boxes features
_C.FASTER.FEATURES_TRAIN = '/data/ihernandez/surgeryDataset/detectron2-experiments/faster_rcnn_R_50_FPN_3x_ava_surgery_bbox_pt/fold1/inference_0001754_debug/inference/bbox_features.pth'

# Path to .pth file with the detected validation boxes features
_C.FASTER.FEATURES_VAL = '/data/ihernandez/surgeryDataset/detectron2-experiments/faster_rcnn_R_50_FPN_3x_ava_surgery_bbox_pt/fold1/inference_0001754_debug/inference/bbox_features.pth'
